  ...
  /*  private int C
    ...
    void OnTriggerEnter2D(Collider2D coll)
    {
        ...
        if (coll.gameObject.tag == "Player" && state == 3)
        {
            ...
            this.transform.position = new Vector3(1, 3, 0);
            state = 0;
            ...
            if (stirPercentage < 100)
            {
                ...
                if (ingredients == 1 && stirPercentage == 100)
                {
                    ...
                    Checkmark1.transform.position = new Vector3(5, 4, 0);
                    Checkmark1.layer = 1;
                }
                if (ingredients == 2 && stirPercentage == 100)
                {
                    ...
                    Checkmark2.transform.position = new Vector3(5, 3.5f, 0);
                    Checkmark2.layer = 1;
                }
                if (ingredients == 3 && stirPercentage == 100)
                {
                    ...
                    Checkmark3.transform.position = new Vector3(5, 3, 0);
                    Checkmark3.layer = 1;
                }
                if (ingredients == 4 && stirPercentage == 100)
                {
                    ...
                    Checkmark4.transform.position = new Vector3(5, 2.5f, 0);
                    Checkmark4.layer = 1;
                }
                ...
                if (ingredients == 4 && stirPercentage == 100)
                {
                    ...
                    FinalCheck.transform.position = new Vector3( 2, 2, 0);
                    FinalCheck.layer = 1;
                    SceneManager.LoadScene("Kitchen");
                    GameManager.foodToGive = GameManager.getGameManager().getFood("Cookie");
